  ...
  return (
    <div className={cn('w-full', className)}>
      ...
      <div className="relative">
        ...
        <div className="relative">
          <div className="absolute left-[12.5%] right-[12.5%] top-[12px] md:top-[16px] h-[2px] bg-gray-200 z-0"></div>
          
          {/* Linha colorida para steps completos */}
          <div 
            className="absolute left-[12.5%] top-[12px] md:top-[16px] h-[2px] z-0"
            style={{
              width: `${adjustedStep === 0 ? 0 : (adjustedStep / (steps.length - 1)) * 75}%`,
