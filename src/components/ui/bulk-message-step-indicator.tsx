...
export interface BulkMessageStepIndicatorProps {
  steps: string[];
  currentStep: number;
  className?: string;
}

export function BulkMessageStepIndicator({
  steps,
  currentStep,
  className,
}: BulkMessageStepIndicatorProps) {
  // Cores para os steps
  ...
  return (
    <div className={cn('w-full', className)}>
      ...
      <div className="relative">
        ...
        {/* Linha base que liga todos os steps - ajustada para não extrapolar */}
        <div className="relative">
          {/* Linha base - calculada para ficar apenas entre os círculos */}
          <div 
